...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraPosition = [1.0, 0.0, 4.0]
      renderView1.CameraFocalPoint = [1.0, 0.0, -8.0]
      ...
      coprocessor.RegisterView(renderView1,
          filename='fig/Wing_VelocityMagnitude_Slice_%t.png', freq=global_freq, fittoscreen=0, magnification=1, width=1920, height=1280, cinema={})
      ...
      # trace defaults for the display properties.
      zSliceDisplay.Representation = 'Surface'
      zSliceDisplay.AmbientColor = [0.0, 0.0, 0.0]
      zSliceDisplay.ColorArrayName = ['POINTS', 'velocity']
      zSliceDisplay.LookupTable = velocityLUT
      zSliceDisplay.OSPRayScaleArray = 'Magnitude'
      zSliceDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
      zSliceDisplay.SelectOrientationVectors = 'None'
      zSliceDisplay.ScaleFactor = 0.4999853134155274
      zSliceDisplay.SelectScaleArray = 'None'
      zSliceDisplay.GlyphType = 'Arrow'
      zSliceDisplay.GlyphTableIndexArray = 'None'
      zSliceDisplay.GaussianRadius = 0.024999265670776368
      zSliceDisplay.SetScaleArray = ['POINTS', 'Magnitude']
      zSliceDisplay.ScaleTransferFunction = 'PiecewiseFunction'
      zSliceDisplay.OpacityArray = ['POINTS', 'Magnitude']
      zSliceDisplay.OpacityTransferFunction = 'PiecewiseFunction'
      zSliceDisplay.DataAxesGrid = 'GridAxesRepresentation'
      zSliceDisplay.SelectionCellLabelFontFile = ''
      zSliceDisplay.SelectionPointLabelFontFile = ''
      zSliceDisplay.PolarAxes = 'PolarAxesRepresentation'

      # init the 'GridAxesRepresentation' selected for 'DataAxesGrid'
      zSliceDisplay.DataAxesGrid.XTitleColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.XTitleFontFile = ''
      zSliceDisplay.DataAxesGrid.YTitleColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.YTitleFontFile = ''
      zSliceDisplay.DataAxesGrid.ZTitleColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.ZTitleFontFile = ''
      zSliceDisplay.DataAxesGrid.GridColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.XLabelColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.XLabelFontFile = ''
      zSliceDisplay.DataAxesGrid.YLabelColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.YLabelFontFile = ''
      zSliceDisplay.DataAxesGrid.ZLabelColor = [0.0, 0.0, 0.0]
      zSliceDisplay.DataAxesGrid.ZLabelFontFile = ''

      # init the 'PolarAxesRepresentation' selected for 'PolarAxes'
      zSliceDisplay.PolarAxes.PolarAxisTitleColor = [0.0, 0.0, 0.0]
      zSliceDisplay.PolarAxes.PolarAxisTitleFontFile = ''
      zSliceDisplay.PolarAxes.PolarAxisLabelColor = [0.0, 0.0, 0.0]
      zSliceDisplay.PolarAxes.PolarAxisLabelFontFile = ''
      zSliceDisplay.PolarAxes.LastRadialAxisTextColor = [0.0, 0.0, 0.0]
      zSliceDisplay.PolarAxes.LastRadialAxisTextFontFile = ''
      zSliceDisplay.PolarAxes.SecondaryRadialAxesTextColor = [0.0, 0.0, 0.0]
      zSliceDisplay.PolarAxes.SecondaryRadialAxesTextFontFile = ''
